...
bg8_40323239_1 = Blueprint('bg8_40323239_1', __name__, url_prefix='/bg8_40323239_1', template_folder='templates')

@bg8_40323239_1.route('/fourcircle', defaults={'n1':17,'n2':29,'n3':15,'n4':23})
@bg8_40323239_1.route('/fourcircle/<n1>/<n2>/<n3>/<n4>')
