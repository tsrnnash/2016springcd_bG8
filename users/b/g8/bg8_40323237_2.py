...
bg8_40323237_2 = Blueprint('bg8_40323237_2', __name__, url_prefix='/bg8_40323237_2', template_folder='templates')
...
class chain():
    ...
    chamber = "M40.000 5.000 A35.000,35.000 0 0,0 5.000,40.000 A35.000,35.000 0 0,0 40.000,75.000 A35.000,35.000 0 0,0 75.000,40.000 A35.000,35.000 0 0,0 40.000,5.000"
...
@bg8_40323237_2.route('/O1')
def O1():
    return head_str + chain_str + O1(40,40) + tail_str 

# 傳繪 A 函式內容
def O1(x, y, scale=1, color="black"):
    outstring = '''
