...
'''
    ...
    return outstring
@bg8_40323239.route('/ABCD')
def ABCD():
    return head_str + chain_str + ABCD(0, 0) + tail_str 

# 傳繪 A 函式內容
def ABCD(x, y, scale=1, color="black"):
    outstring = '''
# 利用 chain class 建立案例, 對應到 mychain 變數
mychain = chain(scale='''+str(scale)+''', fillcolor="'''+str(color)+'''")
...
'''
    return outstring
@bg8_40323239.route('/BADC')
def BADC():
    return head_str + chain_str + BADC(0, 0) + tail_str 

# 傳繪 A 函式內容
def BADC(x, y, scale=1, color="black"):
    outstring = '''
# 利用 chain class 建立案例, 對應到 mychain 變數
mychain = chain(scale='''+str(scale)+''', fillcolor="'''+str(color)+'''")
...
'''
    return outstring
@bg8_40323239.route('/twocircle/<x>/<y>')
@bg8_40323239.route('/twocircle', defaults={'x':0, 'y':0})
def twocircle(x,y):
...
'''
    ...
    return outstring
@bg8_40323239.route('/twocircle2/<x>/<y>')
@bg8_40323239.route('/twocircle2', defaults={'x':0, 'y':0})
def twocircle2(x,y):
